  ...
  return (
    <section className="mt-20 py-4" data-aos='fade-up'>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-x-10 md:gap-x-20 gap-y-2 md:gap-y-0 px-14 md:px-20">
        <a href='https://github.com/OluwapelumiElisha' target="_blank" className="socials-card" data-aos="fade-right">
          <SiGithub className="socials-icon" />
          <p className="font-sans" >GitHub</p>
        </a>
        <a href='https://x.com/Oluwapelum8318' target="_blank" className="socials-card" data-aos="fade-right">
          <FaXTwitter className="socials-icon"/>
          <p className="font-sans">Twitter</p>
        </a>
        <a href='mailto:elishaoluwapelumi38@gmail.com' target="_blank" className="socials-card" data-aos="zoom-in">
          <MdOutlineMailOutline className="socials-icon"/>
          <p className="font-sans" >Email</p>
        </a>
        <a href='https://www.linkedin.com/in/oluwapelumi-elisha-oguntunde-website-developer' target="_blank" className="socials-card" data-aos="zoom-in">
